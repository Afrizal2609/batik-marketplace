...
-- Dumping data for table oke.detail_order: ~42 rows (approximately)
...
-- Dumping data for table oke.order: ~39 rows (approximately)
...
INSERT INTO `order` (`id`, `invoice`, `user_id`, `subtotal`, `no_resi`, `status_order_id`, `metode_pembayaran`, `ongkir`, `created_at`, `updated_at`, `biaya_cod`, `no_hp`, `bukti_pembayaran`, `pesan`) VALUES
	...
	(3, 'ALV202012191208', 7, 999000, '12345', 5, 'trf', 0, '2020-12-19 01:08:52', '2020-12-19 01:11:52', 0, '087678546234', 'buktibayar/iNjHnFsHvcjm63SkfKGpJidHTFHVk6fYnwv9cdgp.jpeg', 'jne'),
	...
	(39, 'ALV202207150431', 7, 1502000, '123', 5, 'cod', 252000, '2022-07-15 16:32:08', '2022-07-15 16:58:17', 10000, '231232131', 'buktibayar/qXa1LSl8VE8VK8Y3IkDfdoaMo9VunEjWsPfm852y.png', 'huh'),
	(40, 'ALV202207160303', 7, 363000, '123', 5, 'trf', 63000, '2022-07-16 03:03:28', '2022-07-16 03:04:54', 0, '1234', 'buktibayar/Wdlg7RALvOFzVNpL8Zlk19p74vbnQCRD2aqQ0mfo.png', 'beli bang'),
	(41, 'ALV202207160448', 7, 213000, '123', 5, 'trf', 63000, '2022-07-16 04:48:52', '2022-07-16 04:50:34', 0, '123312', 'buktibayar/XZ8WagZURa35xGfDQswGLKmyVs2MJRxJ40vWFuDv.png', 'gsdd');
...
INSERT INTO `products` (`id`, `name`, `description`, `image`, `price`, `weigth`, `categories_id`, `created_at`, `updated_at`, `stok`) VALUES
	...
	(2, 'Batik Ciprat Kecubung', 'bahan : primisima ukuran: 2.15 x 1.10\r\n            pewarna: sintetis', 'gambar 1.jpg', '150.000', 500, 5, '2022-03-03 10:03:05', '2022-03-03 10:04:00', 3),
	(3, 'Batik Ciprat Motif Bunga tulip', 'Batik Ciprat motif bunga tulip\r\n            Bahan   : katun primisima Ukuran :105cm x 220cm', 'gambar 7.png', '150.000', 500, 5, '2022-03-03 10:03:05', '2022-03-03 10:04:00', 9),
	(4, 'Batik Pelangi Coret', 'Batik Ciprat Desa Simbatan yang dibuat oleh para penyandang disabilitas\r\n\r\n            Batik Ciprat motif pelangi coret\r\n            Bahan   : katun primisima\r\n            Ukuran  :105cm x 220cm', 'gambar 12.png', '150.000', 500, 3, '2022-03-03 10:03:05', '2022-03-03 10:04:00', -1),
...
-- Dumping data for table oke.reviews: ~4 rows (approximately)
...
-- Dumping data for table oke.status_order: ~6 rows (approximately)
